...
/**
 * Find the master URL for an image if has been generated by frontend.
 *
 * Temporary fix while `/most-read/*.json` do not return the master URLS.
 * This is undoing the work that happens in `Picture.tsx`’s `generateImageURL`,
 * so it should be removed in favour of a the upstream data returning the
 * source of the master image, rather than a specific signed crop
 */
